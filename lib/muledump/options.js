...
//  generate our list of available vault layouts from the default list
    ...
    var options_layout = {
		...
		'wabanitem': 'Wawawa\'s Banner : Items',
		'wabanut': 'Wawawa\'s Banner : Whites',
		'wabandye': 'Wawawa\'s Banner : Dyes',
        // 'wawawabanner': {
            // 'label': 'Wawawa\'s Banner',
            // 'radio': ['watype', {
                // 'withdye': 'With dyes',
                // 'withoutdye': 'Without dyes',
            // }]
        // },
        'shrink': 'Shrink Mules',
	'wanotif': 'Calendar Notifier',
    };

    var globalopts = { 'totals': 1, 'famefilter': 1, 'feedfilter': 1, 'sbfilter': 1, 'nonsbfilter': 1, 'utfilter': 1, 'stfilter': 1, 'wbfilter': 1, 'wanotif': false };
    var hiddenopts = { 'sttype': 4, 'fameamount': 1, 'feedpower': 1, 'vaultlayout': 3, 'chsort': 1, 'chsortchoice': 1, 'vaults': 1};
