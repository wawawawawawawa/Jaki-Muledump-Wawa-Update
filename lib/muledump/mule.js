...
// Mule object
    ...
    Mule.prototype.parse = function(data, skipCacheWrite) {
		...
		///wawa start
		var arr = [];
		var ClassList = { Rogue: {Num: 0}, Archer: {Num: 0}, Wizard: {Num: 0}, Priest: {Num: 0}, Warrior: {Num: 0}, Knight: {Num: 0}, Paladin: {Num: 0}, Assassin: {Num: 0}, Necromancer: {Num: 0}, Huntress: {Num: 0}, Mystic: {Num: 0}, Trickster: {Num: 0}, Sorcerer: {Num: 0}, Ninja: {Num: 0}, Samurai: {Num: 0}, Bard: {Num: 0} };
		var CharNumData = [];
