    ...
    Mule.prototype.parse = function(data, skipCacheWrite) {
        ...
        for (var i = 0; i < carr.length; i++) {
            ...
            if ( this.loginOnly === false && !this.opt('shrink') && this.opt('stats') ) {
				...
				l2mHtml.push('<div class="flex-container" style="flex-direction: row">' + 
				(l2mArray[0] != 0 ? '<div class="flex-container item noFlexAutoWidth" style="background-position: -' + LifePot[3] + 'px -' + LifePot[4] + 'px; border: solid 1px #000; align-self:center; margin-right:5px; flex-shrink:0;"></div><div class="mr10">Life Left : ' + l2mArray[0] + '</div>' : '') + 
				(l2mArray[1] != 0 ? '<div class="flex-container item noFlexAutoWidth" style="background-position: -' + ManaPot[3] + 'px -' + ManaPot[4] + 'px; border: solid 1px #000; align-self:center; margin-right:5px; flex-shrink:0;"></div><div class="mr10">Mana Left : ' + l2mArray[1] + '</div>' : '') + 
				(l2mArray[2] != 0 ? '<div class="flex-container item noFlexAutoWidth" style="background-position: -' + AttPot[3] + 'px -' + AttPot[4] + 'px; border: solid 1px #000; align-self:center; margin-right:5px; flex-shrink:0;"></div><div class="mr10">Att Left : ' + l2mArray[2] + '</div>' : '') + 
				(l2mArray[3] != 0 ? '<div class="flex-container item noFlexAutoWidth" style="background-position: -' + DefPot[3] + 'px -' + DefPot[4] + 'px; border: solid 1px #000; align-self:center; margin-right:5px; flex-shrink:0;"></div><div class="mr10">Def Left : ' + l2mArray[3] + '</div>' : '') + 
				(l2mArray[4] != 0 ? '<div class="flex-container item noFlexAutoWidth" style="background-position: -' + SpdPot[3] + 'px -' + SpdPot[4] + 'px; border: solid 1px #000; align-self:center; margin-right:5px; flex-shrink:0;"></div><div class="mr10">Spd Left : ' + l2mArray[4] + '</div>' : '') + 
				(l2mArray[5] != 0 ? '<div class="flex-container item noFlexAutoWidth" style="background-position: -' + DexPot[3] + 'px -' + DexPot[4] + 'px; border: solid 1px #000; align-self:center; margin-right:5px; flex-shrink:0;"></div><div class="mr10">Dex Left : ' + l2mArray[5] + '</div>' : '') + 
				(l2mArray[6] != 0 ? '<div class="flex-container item noFlexAutoWidth" style="background-position: -' + VitPot[3] + 'px -' + VitPot[4] + 'px; border: solid 1px #000; align-self:center; margin-right:5px; flex-shrink:0;"></div><div class="mr10">Vit Left : ' + l2mArray[6] + '</div>' : '') + 
				(l2mArray[7] != 0 ? '<div class="flex-container item noFlexAutoWidth" style="background-position: -' + WisPot[3] + 'px -' + WisPot[4] + 'px; border: solid 1px #000; align-self:center; margin-right:5px; flex-shrink:0;"></div><div class="mr10">Wis Left : ' + l2mArray[7] + '</div>' : '') + '</div>');
		...
		for (var i in ClassList) {
			CharNumData.push('<div class="flex-container" style="flex-flow:column"><img class="ClassType mr10 mt10" src="lib/' + i + '.png"></img><div class="mr10 mt10">' + ClassList[i]['Num'] + '</div><div class="mr10 mt10">' + i + '</div><div class="mr10 mt10">\xa0' + (d.Account.Stats.ClassStats[stupidvar] ? d.Account.Stats.ClassStats[stupidvar].BestFame : 0) + '</div></div>');
			stupidvar += 1;
		}
		CharNumData.push('</div><div class="flex-container">\xa0</div><div class="flex-container">Total Base Fame : ' + NumberFormat(BaseFameTotal, ',') + ' Fame</div><div class="flex-container" style="flex-flow:column">Total Dead Fame : ' + NumberFormat(DeadFameTotal, ',') + ' Fame</div>' + (l2mHtml ? l2mHtml : '') + '</div>');
		...
		var Totitems = ( typeof gifts === 'string' ) ? gifts.split(',').reverse() : undefined;
		...
		CharNumData.push('<div class="flex-container" style="flex-direction: row">' +
				'<div class="flex-container item noFlexAutoWidth" style="background-position: -' + SlotCoupon[3] + 'px -' + SlotCoupon[4] + 'px; border: solid 1px #000; align-self:center; margin-right:5px; flex-shrink:0;"></div><div class="mr10">Char Slot Coupon : ' + SlotCouponNumber + '</div>' + 
				'<div class="flex-container item noFlexAutoWidth" style="background-position: -' + ChestCoupon[3] + 'px -' + ChestCoupon[4] + 'px; border: solid 1px #000; align-self:center; margin-right:5px; flex-shrink:0;"></div><div class="mr10">Chest Coupon : ' + ChestCouponNumber + '</div>' + 
				'<div class="flex-container item noFlexAutoWidth" style="background-position: -' + STShard[3] + 'px -' + STShard[4] + 'px; border: solid 1px #000; align-self:center; margin-right:5px; flex-shrink:0;"></div><div class="mr10">Mystery ST Shard : ' + STShardNumber + '</div></div>');
