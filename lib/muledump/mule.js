    ...
    Mule.prototype.parse = function(data, skipCacheWrite) {
		...
		// {
			...
			for (var i in ClassList) {
				CharNumData.push('<div class="flex-container" style="flex-flow:column"><div class="item"><img src="lib/' + i + '.png"></img><div style="">' + ClassList[i]['Num'] + '</div></div><div class="flex-container">' + (d.Account.Stats.ClassStats[stupidvar] ? d.Account.Stats.ClassStats[stupidvar].BestFame : 0) + '</div></div>');
				stupidvar += 1;
			}
			stupidvar = 0;
