...
// Mule object
    ...
    Mule.prototype.parse = function(data, skipCacheWrite) {
        ...
        if ( this.loginOnly === false ) {
			...
			var $name = $('<div>').addClass('name').html(d.Account.Name + ' : ' + ((d.Char != undefined ? (d.Char.length != undefined ? d.Char.length + ' / ' + ((data.query.results.other) ? data.query.results.other.maxCharNum : 'N/A') + ' Chars & ' + d.Account.Vault.Chest.length + ' Vaults' : '1 / ' + ((data.query.results.other) ? data.query.results.other.maxCharNum : 'N/A') + ' Char & ' + d.Account.Vault.Chest.length + ' Vaults') : '0 / ' + ((data.query.results.other) ? data.query.results.other.maxCharNum : 'N/A') + ' Char & ' + d.Account.Vault.Chest.length + ' Vaults') || '(No Name) : ' + (d.Char.length != undefined ? d.Char.length + ' / ' + ((data.query.results.other) ? data.query.results.other.maxCharNum : 'N/A') + ' Chars & ' + d.Account.Vault.Chest.length + ' Vaults' : '0 / ' + ((data.query.results.other) ? data.query.results.other.maxCharNum : 'N/A') + ' Char & ' + d.Account.Vault.Chest.length + ' Vaults')));
