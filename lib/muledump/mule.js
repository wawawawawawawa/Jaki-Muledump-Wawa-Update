...
// dom snippet generators
    ...
    function addreloader(mule, target) {
		...
		if ((updated.toString().substring(8,10)) > 26 && updated.toString().substring(8,10) < 31)
		{
			if (check == 0)
			{
    ...
    Mule.prototype.parse = function(data, skipCacheWrite) {
		...
		// {
			...
			for (var tg = 0; tg < Totitems.length; tg++) {
				...
				{
					// console.log(window.items[Totitems[tg]], window.items[Totitems[tg]][10]);
					/// UT
        ...
        // function makechest(items, classname, index) {
            ...
            // return $('<div class="items" data-vaultId="0">').append(il)
		// }
