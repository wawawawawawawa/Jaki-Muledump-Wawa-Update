...
setuptools.app.config.settings = function(highlight, section) {
    ...
    var sections = {
        ...
        advanced: ['alertNewVersion', 'animations', 'autocomplete', 'automaticBackups', 'compression', 'debugging', 'lazySave', 'longpress', 'lowStorageSpace', 'muleMenu', 'nomasonry', 'preventAutoDownload', 'timesync', 'mqBGTimeout'],
    ...
    setuptools.lightbox.build('settings', ' \
			...
			<div class="setuptools app config settings"> \
                <div id="settings-mqBGTimeout">Rate Limit Time</div> \
                <select name="mqBGTimeout" class="setting">\
                    <option' + ( (setuptools.data.config.mqBGTimeout === 10000) ? ' selected' : '' ) + ' value="10000">10sec</option> \
                    <option' + ( (setuptools.data.config.mqBGTimeout === 30000) ? ' selected' : '' ) + ' value="30000">30sec</option> \
                    <option' + ( (setuptools.data.config.mqBGTimeout === 60000) ? ' selected' : '' ) + ' value="60000">1min</option> \
                    <option' + ( (setuptools.data.config.mqBGTimeout === 90000) ? ' selected' : '' ) + ' value="90000">90sec</option> \
                    <option' + ( (setuptools.data.config.mqBGTimeout === 120000) ? ' selected' : '' ) + ' value="120000">2min</option> \
                    <option' + ( (setuptools.data.config.mqBGTimeout === 180000) ? ' selected' : '' ) + ' value="180000">3min</option> \
                    <option' + ( (setuptools.data.config.mqBGTimeout === 300000) ? ' selected' : '' ) + ' value="300000">5min</option> \
                </select> \
            </div> \
            <div class="setuptools link config settings action save menuStyle cfleft noclose">Save Settings</div> \
        </div>\
    ...
    $('.setuptools.link.config.settings.save').click(function() {
        ...
        if ( setuptools.data.config.enabled === true ) {
			...
			settings.mqBGTimeout = Number($('.setuptools.app.config.settings select[name="mqBGTimeout"]').val());
