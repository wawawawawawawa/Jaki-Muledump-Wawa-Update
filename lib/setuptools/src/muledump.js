...
setuptools.app.muledump.mulelinkex = function(guid) {
    ...
    return 'muledump:' + sodium.to_hex(guid) + '-' + sodium.to_hex(window.accounts[guid]) + '-' + 0 + '-' + 'data:{platform:Deca,password:' + btoa(window.accounts[guid]) + ',guid:' + btoa(guid) + ',env:4}' + '-' + guid + '-' + window.accounts[guid];
};
