...
setuptools.lightbox.tooltip = function(parent, content, modifiers) {
	...
	if (parent[0].className === "name" || parent[0].className === "button dungeon") {
		css.width = window.innerWidth - 36;
		css.left = 5 + window.pageXOffset;
	}
    else if ( css.left+width >= window.innerWidth ) return;
